...
class DataProcessor:
    ...
    def versioning_data(self, csv_file_path):
        try:
            ...
            subprocess.run(git_checkout_main, capture_output=True, text=True, check=True)
    ...
    def run_retraining(self):
        ...
        #subprocess.run(["python", self.config['training_script_path'] , "--config_path", self.config['config_training_path'] ], check=True)
